...
runFlattener Schema { types, tops, namespace, quals, imports, typesExtended, elementsExtended} act =
  ...
  where
    loop = do
      ...
      finalTypes <- get
      return Schema { types=finalTypes, tops=tops', namespace, quals, imports, typesExtended, elementsExtended}
